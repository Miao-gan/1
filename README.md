...
function Library:create(options)
	...
	options = self:set_defaults({
		...
		Link = "游戏ID:"..game.GameId.."游戏名"..game.GameName..
	}, options)
	...
	creditsTab:credit{Name = "制作者", Description = "LIB制作者", QQ = "3891807137"}
	return mt
end
