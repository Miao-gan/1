...
function Library:create(options)
	...
	options = self:set_defaults({
		...
		Link = ("游戏ID"..game.GameId.."游戏名称"..game.GameName)
	}, options)
	...
	creditsTab:credit{Name = "制作者MIAO", Description = "一个简简单单UILibrary"}
...
locallabelcontainer = self。容器:对象(“TextButton”{
主题= {BackgroundColor3 = “二级”}，
Size = UDim2。New (1, - 20,0,52)，
...
Text = options。文本,
TextSize = 22；
主题= {TextColor3 = StrongText”}，
		TextXAlignment = Enum.TextXAlignment.Left
	})

localdescription = labelContainer:object（“TextLabel”, {）
backgroundtransparent = 1，
位置= UDim2。New (0,10,1, -5)，
Size = UDim2.new(0.5, - 10,1, -22)，
Text = options。描述,
		TextSize = 18,
锚点= Vector2。新(0,1),
主题= {TextColor3 = "WeakText"}，
		TextXAlignment = Enum.TextXAlignment.Left
	})
